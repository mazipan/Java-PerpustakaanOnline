        ...
        <script>
            $(function() {
                ...
                function setPaging() {
                    ...
                    var urlMin = 'controler?/action=memberbookstorefilterbyyear&id=' + idYear + '&page=' + currentPageMin;
                    var url = 'controler?/action=memberbookstorefilterbyyear&id=' + idYear + '&page=';
                    var urlPlus = 'controler?/action=memberbookstorefilterbyyear&id=' + idYear + '&page=' + currentPagePlus;
