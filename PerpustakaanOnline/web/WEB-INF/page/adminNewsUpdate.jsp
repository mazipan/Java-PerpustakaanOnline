            ...
            <div id="contents">
                <div class="content-module ">
                    <div class="content-module-heading cf">
                        <h3 class="fl">News Update List</h3>
                        <a href="controler?/action=adminnewsupdateedit" class="fr link" style="padding-right: 20px; padding-top: 20px;">Add New News Update<font class="fr font-icon" style="padding-left: 10px;">+</font></a>
                    </div>
                    <div class="content-module-main">
                            ...
                            <tbody>
                                ...
                                <c:forEach items="${newsList}" var="news">    
                                    <tr>
                                        ...
                                        <td>
                                            ${news.newsDateTimeStrItalic}
                                        </td>
                                        <td>
                                            <a href="controler?/action=adminnewsupdateedit&id=${news.idNews}" class="table-actions-button ic-table-edit"></a>
                                            <a href="controler?/action=adminnewsupdatedelete&id=${news.idNews}" class="table-actions-button ic-table-delete"></a>
                                        </td>
                                    </tr>
                                    <%i++;%>
                                </c:forEach>
                                ...
                                <tr>
                                    <td colspan="5" class="table-footer" id="bookfooter">
                                        ...
                                        <c:if test="${currentPage != 1}">
                                            <a href="controler?/action=adminnewsupdate&page=${currentPage - 1}">Previous </a>
                                        </c:if>
                                        ...
                                        <c:forEach begin="1" end="${noOfPages}" var="i">
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    <a href="controler?/action=adminnewsupdate&page=${i}">${i} </a>
                                                </c:otherwise>
                                            </c:choose>
                                        </c:forEach>
                                        <%--For displaying Next link --%>
                                        <c:if test="${currentPage lt noOfPages}">                                           
                                            <a href="controler?/action=adminnewsupdate&page=${currentPage + 1}"> Next</a>
                                        </c:if>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <label style="color: red; font-size: 12pt">*) Only last record will be show to member</label></br>
