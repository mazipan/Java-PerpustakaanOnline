                                ...
                                <tr>
                                    <td colspan="5" class="table-footer">
                                        ...
                                        <c:if test="${currentPage != 1}">
                                            <a href="controler?/action=admintransactionbybook&page=${currentPage - 1}">Previous </a>
                                        </c:if>
                                        ...
                                        <c:forEach begin="1" end="${noOfPages}" var="i">
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    <a href="controler?/action=admintransactionbybook&page=${i}">${i} </a>
                                                </c:otherwise>
                                            </c:choose>
                                        </c:forEach>
                                        <%--For displaying Next link --%>
                                        <c:if test="${currentPage lt noOfPages}">
                                            <a href="controler?/action=admintransactionbybook&page=${currentPage + 1}"> Next</a>
                                        </c:if>
                                    </td>
                                </tr>
                            </table>
