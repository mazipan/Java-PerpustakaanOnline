...
<html>
    ...
    <body>
        <div id="contents">
            ...
            <p style="text-align: center;"><a href="controler?/action=memberbookstore">click here</a> if your browser does not automatically redirect.</p>
        </div><!--div contents-->
        ...
        <script>
            $(function() {
                setTimeout(function() {
                    window.location.href = "controler?/action=memberbookstore";
                }, 3000);
            });
        </script>
