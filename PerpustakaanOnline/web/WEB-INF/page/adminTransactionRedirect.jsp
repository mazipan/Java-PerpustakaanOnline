...
<html>
    ...
    <body>
        <div id="contents">
            ...
            <p style="text-align: center;"><a href="controler?/action=admintransaction">click here</a> if your browser does not automatically redirect.</p>
        </div><!--div contents-->
        ...
        <script>
            $(function() {
                setTimeout(function() {
                    window.location.href = "controler?/action=admintransaction";
                }, 5000);
            });
        </script>
