        ...
        <script>
            $(function() {
                ...
                function setPaging() {
                    ...
                    var urlMin = 'controler?/action=adminbookfilterbycategory&id=' + idCat + '&page=' + currentPageMin;
                    var url = 'controler?/action=adminbookfilterbycategory&id=' + idCat + '&page=';
                    var urlPlus = 'controler?/action=adminbookfilterbycategory&id=' + idCat + '&page=' + currentPagePlus;
