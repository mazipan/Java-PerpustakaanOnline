 ...
 * @author mazipan
 */
public class MemberBookStoreFilterByYear implements ActionInterface {
    ...
    public String execute(HttpServletRequest request) {
        ...
        if (member != null) {
            try {
                ...
                try {
                    ...
                    if (idYear != null) {
                        ...
                        if (idYear.equalsIgnoreCase("All")) {
                            ...
                            //books = bookDAO.selectWhereNotDipinjamByYear(idYear);
                            books = bookDAO.selectWhereNotDipinjamByYear(idYear);

                            books = bookDAO.selectWhereNotDipinjamByYearWithLimit(idYear, (pages - 1) * recordsPerPage, recordsPerPage);

                            noOfRecords = bookDAO.getNoOfRecordsWhereNotDipinjamByYear(idYear);
                            noOfPages = (int) Math.ceil(noOfRecords * 1.0 / recordsPerPage);
                        }
                ...
                return "memberBookStoreYear.jsp";
