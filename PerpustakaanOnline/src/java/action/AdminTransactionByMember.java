 ...
 * @author mazipan
 */
public class AdminTransactionByMember implements ActionInterface {
    ...
    public String execute(HttpServletRequest request) {
        ...
        if (administrator != null) {
            try {
                ...
                try {
                    ...
                    if (filter != null) {
                        if (!filter.equalsIgnoreCase("")) {
                            peminjamans = peminjamanDao.FilterByMember(filter, (page - 1) * recordsPerPage, recordsPerPage);

                            noOfRecords = peminjamanDao.FilterByMemberCount(filter);
                            noOfPages = (int) Math.ceil(noOfRecords * 1.0 / recordsPerPage);
                            request.setAttribute("memberSearch", filter);
                            request.removeAttribute("bookSearch");
                        } else {
                ...
                return "adminTransactionByMember.jsp";
